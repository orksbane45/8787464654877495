...
<p>ffprobe [<var>options</var>] [&lsquo;<tt>input_url</tt>&rsquo;]
</p>
...
<dt>&lsquo;<samp>-show_data_hash <var>algorithm</var></samp>&rsquo;</dt>
<dd><p>Show a hash of payload data, for packets with &lsquo;<samp>-show_packets</samp>&rsquo; and for
codec extradata with &lsquo;<samp>-show_streams</samp>&rsquo;.
</p>
</dd>
...
<dt>&lsquo;<samp>-show_log <var>loglevel</var></samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-show_pixel_formats</samp>&rsquo;</dt>
...
&lsquo;<samp>.</samp>&rsquo; is the subgroup separator
</li><li>
newline, &lsquo;<samp>\t</samp>&rsquo;, &lsquo;<samp>\f</samp>&rsquo;, &lsquo;<samp>\b</samp>&rsquo; and the following characters are
escaped
</li><li>
&lsquo;<samp>\</samp>&rsquo; is the escape character
</li><li>
&lsquo;<samp>#</samp>&rsquo; is the comment indicator
</li><li>
&lsquo;<samp>=</samp>&rsquo; is the key/value separator
</li><li>
&lsquo;<samp>:</samp>&rsquo; is not used but usually parsed as key/value separator
</li></ul>
...
<dt>&lsquo;<samp>xsd_strict, x</samp>&rsquo;</dt>
