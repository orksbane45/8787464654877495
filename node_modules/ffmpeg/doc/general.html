...
<h1 class="titlefont">General Documentation</h1>
<hr>
<a name="SEC_Top"></a>
...
<ul class="no-bullet">
  ...
  <ul class="no-bullet">
    <li><a name="toc-Alliance-for-Open-Media-libaom" href="#Alliance-for-Open-Media-libaom">1.1 Alliance for Open Media libaom</a></li>
    <li><a name="toc-OpenJPEG" href="#OpenJPEG">1.2 OpenJPEG</a></li>
    <li><a name="toc-OpenCORE_002c-VisualOn_002c-and-Fraunhofer-libraries" href="#OpenCORE_002c-VisualOn_002c-and-Fraunhofer-libraries">1.3 OpenCORE, VisualOn, and Fraunhofer libraries</a>
    <ul class="no-bullet">
      <li><a name="toc-OpenCORE-AMR" href="#OpenCORE-AMR">1.3.1 OpenCORE AMR</a></li>
      <li><a name="toc-VisualOn-AMR_002dWB-encoder-library" href="#VisualOn-AMR_002dWB-encoder-library">1.3.2 VisualOn AMR-WB encoder library</a></li>
      <li><a name="toc-Fraunhofer-AAC-library" href="#Fraunhofer-AAC-library">1.3.3 Fraunhofer AAC library</a></li>
    </ul></li>
    <li><a name="toc-LAME" href="#LAME">1.4 LAME</a></li>
    <li><a name="toc-TwoLAME" href="#TwoLAME">1.5 TwoLAME</a></li>
    <li><a name="toc-libcodec2-_002f-codec2-general" href="#libcodec2-_002f-codec2-general">1.6 libcodec2 / codec2 general</a></li>
    <li><a name="toc-libvpx" href="#libvpx">1.7 libvpx</a></li>
    <li><a name="toc-libwavpack" href="#libwavpack">1.8 libwavpack</a></li>
    <li><a name="toc-libxavs" href="#libxavs">1.9 libxavs</a></li>
    <li><a name="toc-OpenH264" href="#OpenH264">1.10 OpenH264</a></li>
    <li><a name="toc-x264" href="#x264">1.11 x264</a></li>
    <li><a name="toc-x265" href="#x265">1.12 x265</a></li>
    <li><a name="toc-kvazaar" href="#kvazaar">1.13 kvazaar</a></li>
    <li><a name="toc-libilbc" href="#libilbc">1.14 libilbc</a></li>
    <li><a name="toc-libzvbi" href="#libzvbi">1.15 libzvbi</a></li>
    <li><a name="toc-AviSynth" href="#AviSynth">1.16 AviSynth</a></li>
    <li><a name="toc-Intel-QuickSync-Video" href="#Intel-QuickSync-Video">1.17 Intel QuickSync Video</a></li>
    <li><a name="toc-AMD-VCE" href="#AMD-VCE">1.18 AMD VCE</a></li>
  </ul></li>
...
<a name="Alliance-for-Open-Media-libaom"></a>
<h2 class="section"><a href="general.html#toc-Alliance-for-Open-Media-libaom">1.1 Alliance for Open Media libaom</a></h2>

<p>FFmpeg can make use of the libaom library for AV1 decoding.
</p>
...
<a name="OpenJPEG"></a>
<h2 class="section"><a href="general.html#toc-OpenJPEG">1.2 OpenJPEG</a></h2>
...
<h2 class="section"><a href="general.html#toc-OpenCORE_002c-VisualOn_002c-and-Fraunhofer-libraries">1.3 OpenCORE, VisualOn, and Fraunhofer libraries</a></h2>
...
<h3 class="subsection"><a href="general.html#toc-OpenCORE-AMR">1.3.1 OpenCORE AMR</a></h3>
...
<h3 class="subsection"><a href="general.html#toc-VisualOn-AMR_002dWB-encoder-library">1.3.2 VisualOn AMR-WB encoder library</a></h3>
...
<h3 class="subsection"><a href="general.html#toc-Fraunhofer-AAC-library">1.3.3 Fraunhofer AAC library</a></h3>
...
<a name="LAME"></a>
<h2 class="section"><a href="general.html#toc-LAME">1.4 LAME</a></h2>
...
<a name="TwoLAME"></a>
<h2 class="section"><a href="general.html#toc-TwoLAME">1.5 TwoLAME</a></h2>
...
<a name="libcodec2-_002f-codec2-general"></a>
<h2 class="section"><a href="general.html#toc-libcodec2-_002f-codec2-general">1.6 libcodec2 / codec2 general</a></h2>

<p>FFmpeg can make use of libcodec2 for codec2 encoding and decoding.
...
<a name="libvpx"></a>
<h2 class="section"><a href="general.html#toc-libvpx">1.7 libvpx</a></h2>
...
<a name="libwavpack"></a>
<h2 class="section"><a href="general.html#toc-libwavpack">1.8 libwavpack</a></h2>
...
<a name="libxavs"></a>
<h2 class="section"><a href="general.html#toc-libxavs">1.9 libxavs</a></h2>

<p>FFmpeg can make use of the libxavs library for Xavs encoding.
</p>
...
<a name="OpenH264"></a>
<h2 class="section"><a href="general.html#toc-OpenH264">1.10 OpenH264</a></h2>

<p>FFmpeg can make use of the OpenH264 library for H.264 encoding and decoding.
</p>
...
<a name="x264"></a>
<h2 class="section"><a href="general.html#toc-x264">1.11 x264</a></h2>
...
<a name="x265"></a>
<h2 class="section"><a href="general.html#toc-x265">1.12 x265</a></h2>
...
<a name="kvazaar"></a>
<h2 class="section"><a href="general.html#toc-kvazaar">1.13 kvazaar</a></h2>
...
<a name="libilbc"></a>
<h2 class="section"><a href="general.html#toc-libilbc">1.14 libilbc</a></h2>
...
<a name="libzvbi"></a>
<h2 class="section"><a href="general.html#toc-libzvbi">1.15 libzvbi</a></h2>
...
<a name="AviSynth"></a>
<h2 class="section"><a href="general.html#toc-AviSynth">1.16 AviSynth</a></h2>
...
<a href="http://avs-plus.net">AviSynth+ r1718 or higher</a> for 32-bit and 64-bit builds.
</p>
<p>For Linux and OS X, the supported AviSynth variant is
<a href="https://github.com/avxsynth/avxsynth">AvxSynth</a>.
</p>
<div class="float alert alert-info">
<p>There is currently a regression in AviSynth+&rsquo;s <code>capi.h</code> header as of
...
<p><code>git clone -b MT git://github.com/AviSynth/AviSynthPlus.git <br>
cd AviSynthPlus <br>
git checkout -b oldheader b4f292b4dbfad149697fb65c6a037bb3810813f9 <br>
make install PREFIX=/install/prefix</code>
</p></div>
<div class="float alert alert-info">
...
<h2 class="section"><a href="general.html#toc-Intel-QuickSync-Video">1.17 Intel QuickSync Video</a></h2>

<p>FFmpeg can use Intel QuickSync Video (QSV) for accelerated encoding and decoding
...
<a name="AMD-VCE"></a>
<h2 class="section"><a href="general.html#toc-AMD-VCE">1.18 AMD VCE</a></h2>

<p>FFmpeg can use the AMD Advanced Media Framework library for accelerated H.264
...
<tr><td width="40%">AV1</td><td width="10%"></td><td width="10%">E</td><td width="40%">Supported through external library libaom</td></tr>
